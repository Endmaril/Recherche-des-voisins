...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/trunk/GraphicsView/include/CGAL/Qt/TriangulationGraphicsColoredItem.h $
// $Id: TriangulationGraphicsColoredItem.h 61414 2011-02-24 16:36:04Z sloriot $
// 
//
// Author(s)     : Andreas Fabri <Andreas.Fabri@geometryfactory.com>
//                 Laurent Rineau <Laurent.Rineau@geometryfactory.com>

#ifndef CGAL_QT_TRIANGULATION_GRAPHICS_COLORED_ITEM_H
#define CGAL_QT_TRIANGULATION_GRAPHICS_COLORED_ITEM_H
...
template <typename T>
class TriangulationGraphicsColoredItem : public GraphicsItem
{
  typedef typename T::Geom_traits Geom_traits;
public:
  TriangulationGraphicsColoredItem(T* t_);
...
template <typename T>
TriangulationGraphicsColoredItem<T>::TriangulationGraphicsColoredItem(T * t_)
...
template <typename T>
QRectF 
TriangulationGraphicsColoredItem<T>::boundingRect() const
{
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::operator()(typename T::Face_handle fh)
{
  if(visible_edges) {
    for (int i=0; i<3; i++) {
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::drawAll(QPainter *painter)
{
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::paintVertices(QPainter *painter)
{
  if(visibleVertices()) {
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::paintOneVertex(const typename T::Point& point)
{
  Converter<Geom_traits> convert;
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::paintVertex(typename T::Vertex_handle vh)
{
  Converter<Geom_traits> convert;
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::paint(QPainter *painter, 
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::updateBoundingBox()
{
...
template <typename T>
void 
TriangulationGraphicsColoredItem<T>::modelChanged()
{
  if((t->number_of_vertices() == 0) ){
    this->hide();
...
#endif // CGAL_QT_TRIANGULATION_GRAPHICS_COLORED_ITEM_H
